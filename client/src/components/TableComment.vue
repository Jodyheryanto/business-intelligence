        ...
        fillData(){
            ...
            for(var i = 0; i < data.length; i++){
                if(data[i].sumber === this.source){
                    ...
                    this.items.push({id: data[i].id, account: { username: data[i].username, user_avatar: data[i].user_avatar }, post_sample: data[i].post, post: post_count, sentiment: { positive: positive_count, negative: negative_count }, engagement: engagement_count})
                }
            }
